...
class User extends CI_Controller
{
    ...
    public function announcement()
    {
        ...
        $data['user'] = $this->db->get_where('user', ['email' =>
        $this->session->userdata('email')])->row_array();
        $data['announcement'] = $this->db->order_by('date_created', 'DESC')->get('secretary_announcement')->result_array();
    ...
    public function viewAnnouncement($id)
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('user/view-announcement', $data);
        $this->load->view('templates/footer');
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!password_verify($current_password, $data['user']['password'])) {
                ...
                if ($current_password == $new_password) {
                    $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">New password can not same as current password</div>');
                    redirect('user/changepassword');
                } else {
