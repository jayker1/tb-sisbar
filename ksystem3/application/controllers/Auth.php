...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = "K-System Registration";
            $this->load->view('templates/auth_header', $data);
            ...
            $data = [
                ...
                'division' => htmlentities($this->input->post('division', true)),
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'ksystem333@gmail.com',
            'smtp_pass' => 'Ksystem_123',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('ksystem333@gmail.com', 'K-System Application');
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-dangers" role="alert">Email is not registered or activated!</div>');
                redirect('auth/forgotpassword');
            }
        }
    }
    ...
    public function resetpassword()
    {
        ...
        if ($user) {
            ...
            if ($user_token) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-dangers" role="alert">Reset Password failed! Wrong Token!</div>');
                redirect('auth/forgotpassword');
            }
        } else {
            $this->session->set_flashdata('message', '<div class="alert alert-dangers" role="alert">Reset Password failed! Wrong Email!</div>');
            redirect('auth/forgotpassword');
        }
    }
