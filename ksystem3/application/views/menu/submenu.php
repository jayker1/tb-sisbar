                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="" class="badge badge-success" data-toggle="modal" data-target="#newEditSubMenuModal<?= $sm['id']; ?>">edit</a>
                                <a href="<?= base_url('menu/deletesubmenu/') . $sm['id']; ?>" class="badge badge-danger" onclick="return confirm('Do you want to delete this <?= $sm['title'] ?> Submenu?')" class="badge badge-danger" class=" badge badge-danger">delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach ?>
...
<!-- Edit Modal -->
<?php foreach ($subMenu as $sm) : ?>
    <div class="modal fade" id="newEditSubMenuModal<?= $sm['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="newEditSubMenuModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
