        ...
        <div class="col-lg">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('secretary/information'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="topic" name="topic" placeholder="Write topic here...">
                            <?= form_error('topic', '<small class="text-danger pl-3">', ' </small>') ?>
                        </div>
                        <label for="topic">Information</label>
                        <textarea class="form-control" id="information" name="information" placeholder="Write information here..."></textarea>
